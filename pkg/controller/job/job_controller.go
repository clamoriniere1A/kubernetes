...
func (jm *JobController) enqueueJob(job interface{}) {
	...
	backoff := retrieveBackoff(jm.queue, key)
...
func retrieveBackoff(queue workqueue.RateLimitingInterface, key interface{}) time.Duration {
