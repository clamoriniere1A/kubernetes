...
var map_JobSpec = map[string]string{
	...
	"backoffDeadlineSeconds": "Specifies the time (in seconds) specifying how long a job should be retried before marking it failed.",
	"failedPodsLimit":        "Optional number of failed pods to retain.",
...
var map_JobStatus = map[string]string{
	...
	"failedAndDeleted": "The number of pods which reached phase Failed and also deleted.",
}
